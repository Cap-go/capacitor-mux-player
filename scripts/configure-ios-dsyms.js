...
const frameworkNames = ['MuxCore'];
const phaseName = 'Capgo dSYMs for MuxCore';
...
\t\t\t);
\t\t\toutputPaths = (
\t\t\t\t"$(ARCHIVE_PATH)/dSYMs/MuxCore.framework.dSYM",
\t\t\t\t"$(DWARF_DSYM_FOLDER_PATH)/MuxCore.framework.dSYM",
\t\t\t);
